  ...
  return <div className="service">
    <div className="service-container">
      <div className="service-inner-container">
        <h1 className="service-inner-container-h1">
          My Awesome Service
        </h1>
        <p className="service-inner-container-h1-p">
          There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration.
        </p>
      </div>
      <div className="service-grid">
        <div className="service-grid-container">
          <a className="service-grid-container-a" href="xyz">
            <div className="service-grid-container-inner">
              <div className="service-grid-container-inner-icon">
        ...
        <div className="service-grid-container">
          <a className="service-grid-container-a" href="xyz">
            <div className="service-grid-container-inner">
              <div className="service-grid-container-inner-icon">
                <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"></rect><line x1="8" y1="21" x2="16" y2="21"></line><line x1="12" y1="17" x2="12" y2="21"></line></svg></div>
              <div className="service-grid-container-inner-content">
                <h3 className="service-grid-container-inner-content-h3">
                  Mobile App Development
                </h3>
